...
import type { AttendanceStatusDeleteParamsT, AttendanceStatusT } from "../attendance-status.types";

interface AttendanceStatusDeleteModalProps {
  isOpen: boolean;
  attendanceStatus: AttendanceStatusT | null;
  onClose: () => void;
  onSoftDelete: (params: AttendanceStatusDeleteParamsT) => Promise<SoftDeleteResponseT>;
}

export const AttendanceStatusDeleteModal: React.FC<AttendanceStatusDeleteModalProps> = ({
  isOpen,
  attendanceStatus,
  onClose,
  onSoftDelete,
        ...
        <div className="p-5">
            ...
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div className="space-y-2">
                <p className="text-sm text-slate-900 font-medium">
                  ¿Desactivar estado{" "}
                  <span className="font-semibold">{attendanceStatus.name}</span>?
                </p>
                {message && (
          ...
          {phase === "done" && (
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div>
                <p className="text-sm text-slate-900 font-medium">
                  Estado <span className="font-semibold">{attendanceStatus.name}</span> desactivado
                </p>
