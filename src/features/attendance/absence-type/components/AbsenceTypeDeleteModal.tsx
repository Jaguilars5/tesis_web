...
import type { AbsenceTypeDeleteParamsT, AbsenceTypeT } from "../absence-type.types";

interface AbsenceTypeDeleteModalProps {
  isOpen: boolean;
  absenceType: AbsenceTypeT | null;
  onClose: () => void;
  onSoftDelete: (params: AbsenceTypeDeleteParamsT) => Promise<SoftDeleteResponseT>;
}

export const AbsenceTypeDeleteModal: React.FC<AbsenceTypeDeleteModalProps> = ({
  isOpen,
  absenceType,
  onClose,
  onSoftDelete,
        ...
        <div className="p-5">
            ...
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div className="space-y-2">
                <p className="text-sm text-slate-900 font-medium">
                  ¿Desactivar tipo de ausencia{" "}
                  <span className="font-semibold">{absenceType.name}</span>?
                </p>
                {message && (
          ...
          {phase === "done" && (
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div>
                <p className="text-sm text-slate-900 font-medium">
                  Tipo de ausencia <span className="font-semibold">{absenceType.name}</span> desactivado
                </p>
