...
interface State { data: AbsenceTypeT | null; loading: boolean; error: string | null; }
type Action = { type: "loading" } | { type: "success"; data: AbsenceTypeT } | { type: "error"; error: string };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg animate-slide-up overflow-hidden rounded-xl bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Detalle de Tipo de Ausencia</h3>
            <p className="mt-0.5 text-sm text-slate-500">Información del tipo de ausencia</p>
          </div>
