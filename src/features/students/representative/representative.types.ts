...
export interface RepresentativeListParamsT { page?: number; pageSize?: number; search?: string; ordering?: RepresentativeOrderingT; filters?: Record<string, string | number | boolean>; }
