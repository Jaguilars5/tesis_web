...
export const StudentViewModal = ({ isOpen, studentId, onClose }: Props) => {
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <DetailRow
                  icon={<BookOpen className="size-4" />}
                  label="Edad"
                  value={state.data.age != null ? String(state.data.age) : "—"}
                />
              ...
              <div className="space-y-4">
                ...
                {state.data.primary_representative ? (
                  <>
                    <DetailRow
                      icon={<User className="size-4" />}
                      label="Nombre"
                      value={state.data.primary_representative.user_names}
                    />
                    <DetailRow
                      icon={<User className="size-4" />}
                      label="Parentesco"
                      value={state.data.primary_representative.kinship_name}
                    />
                  </>
                ) : (
