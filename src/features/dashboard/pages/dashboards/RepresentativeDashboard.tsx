  ...
  return (
    <div>
      <PageHeader
        ...
        description="Panel de seguimiento académico"
      />
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between rounded-lg border border-slate-200 p-3">
              <div>
                <p className="font-medium text-sm">María José Ramírez López</p>
                <p className="text-xs text-slate-500">5to Grado - Sección A</p>
              </div>
              <Badge>Promedio: 9.2</Badge>
            </div>
            <div className="flex items-center justify-between rounded-lg border border-slate-200 p-3">
              <div>
                <p className="font-medium text-sm">Juan Carlos Ramírez López</p>
                <p className="text-xs text-slate-500">3er Grado - Sección B</p>
              </div>
              <Badge>Promedio: 8.5</Badge>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between rounded-lg border border-slate-200 p-3">
              <div>
                <p className="font-medium text-sm">Juan Carlos Ramírez</p>
                <p className="text-xs text-slate-500">85% asistencia - Umbral bajo</p>
              </div>
