...
interface SectionDeleteModalProps {
  ...
  onClose: () => void;
  onSoftDelete: (params: SectionDeleteParamsT) => Promise<SoftDeleteResponseT>;
}
        ...
        <div className="p-5">
            ...
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div className="space-y-2">
                <p className="text-sm text-slate-900 font-medium">
                  ¿Desactivar sección{" "}
                  <span className="font-semibold">{section.parallel}</span>?
                </p>
                {message && (
          ...
          {phase === "done" && (
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div>
                <p className="text-sm text-slate-900 font-medium">
                  Sección <span className="font-semibold">{section.parallel}</span> desactivada
                </p>
