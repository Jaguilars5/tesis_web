...
import { SectionFormModal } from "../components/form/SectionFormModal";
import { SectionTable } from "../components/form/SectionTable";
import { useSectionForm } from "../presentation/hooks/useSectionForm";
      ...
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Gestiona los paralelos de tu institucion
          </p>
        </div>
        <button
          type="button"
