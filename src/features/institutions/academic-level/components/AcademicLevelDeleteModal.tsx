...
interface AcademicLevelDeleteModalProps {
  isOpen: boolean;
  academicLevel: AcademicLevelT | null;
  onClose: () => void;
  onSoftDelete: (
...
export const AcademicLevelDeleteModal: React.FC<
  AcademicLevelDeleteModalProps
> = ({ isOpen, academicLevel, onClose, onSoftDelete }) => {
  const {
    phase,
    message,
    affectedRecords,
  ...
  if (!isOpen || !academicLevel) return null;
        ...
        <div className="p-5">
            ...
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div className="space-y-2">
                <p className="text-sm text-slate-900 font-medium">
                  ¿Desactivar{" "}
                  <span className="font-semibold">{academicLevel.name}</span>?
                </p>
                {message && (
          ...
          {phase === "done" && (
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div>
                <p className="text-sm text-slate-900 font-medium">
                  <span className="font-semibold">{academicLevel.name}</span> desactivado
                </p>
