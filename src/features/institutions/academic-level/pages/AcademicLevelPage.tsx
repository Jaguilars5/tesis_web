...
import { AcademicLevelFormModal } from "../components/form/AcademicLevelFormModal";
import { AcademicLevelTable } from "../components/form/AcademicLevelTable";
import { useAcademicLevelForm } from "../presentation/hooks/useAcademicLevelForm";
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Gestiona los niveles de enseñanza de tu institución
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <AcademicLevelTable onEdit={openModal} />
      </div>
