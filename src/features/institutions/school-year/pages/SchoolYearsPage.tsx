...
import { SchoolYearFormModal } from "../components/form/SchoolYearFormModal";
import { SchoolYearTable } from "../components/form/SchoolYearTable";
import { useSchoolYearForm } from "../presentation/hooks/useSchoolYearForm";
      ...
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Gestiona los años lectivos de tu institución
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div className="flex flex-wrap gap-3 border-b border-slate-200 bg-slate-50/50 px-4 py-3">
          <div className="relative min-w-50 flex-1">
            ...
            <input
              type="text"
              placeholder="Filtrar años escolares..."
        ...
        <SchoolYearTable onEdit={openModal} />
      </div>
