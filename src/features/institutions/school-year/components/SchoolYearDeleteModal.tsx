...
interface SchoolYearDeleteModalProps {
  isOpen: boolean;
  schoolYear: SchoolYearT | null;
  onClose: () => void;
  onSoftDelete: (
...
export const SchoolYearDeleteModal: React.FC<SchoolYearDeleteModalProps> = ({
  isOpen,
  schoolYear,
  onClose,
  onSoftDelete,
        ...
        <div className="p-5">
            ...
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div className="space-y-2">
                <p className="text-sm text-slate-900 font-medium">
                  ¿Desactivar{" "}
                  <span className="font-semibold">{schoolYear.name}</span>?
                </p>
                {message && (
          ...
          {phase === "done" && (
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div>
                <p className="text-sm text-slate-900 font-medium">
                  <span className="font-semibold">{schoolYear.name}</span> desactivado
                </p>
