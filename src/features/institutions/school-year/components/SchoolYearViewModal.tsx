...
type SchoolYearViewModalAction =
  | { type: "loading" }
  | { type: "success"; data: SchoolYearT }
  | { type: "error"; error: string };

const reducer = (
  state: SchoolYearViewModalState,
  action: SchoolYearViewModalAction,
): SchoolYearViewModalState => {
  switch (action.type) {
    case "loading":
...
interface SchoolYearViewModalProps {
  isOpen: boolean;
  schoolYearId: number | null;
  onClose: () => void;
}

export const SchoolYearViewModal = ({
  isOpen,
  schoolYearId,
  onClose,
}: SchoolYearViewModalProps) => {
