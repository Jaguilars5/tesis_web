...
interface PeriodTypeDeleteModalProps {
  isOpen: boolean;
  entity: PeriodTypeT | null;
  onClose: () => void;
  onSoftDelete: (params: SoftDeleteParamsT) => Promise<SoftDeleteResponseT>;
}

export const PeriodTypeDeleteModal: React.FC<PeriodTypeDeleteModalProps> = ({ isOpen, entity, onClose, onSoftDelete }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm animate-slide-up overflow-hidden rounded-xl bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
          <h3 className="text-lg font-semibold text-slate-900">Desactivar Tipo de Periodo</h3>
