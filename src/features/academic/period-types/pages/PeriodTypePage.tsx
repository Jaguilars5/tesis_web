...
import { PeriodTypeFormModal } from "../components/form/PeriodTypeFormModal";
import { PeriodTypeTable } from "../components/form/PeriodTypeTable";
import { usePeriodTypeForm } from "../presentation/hooks/usePeriodTypeForm";
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-800">Tipos de Periodo</h1>
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <PeriodTypeTable onEdit={openModal} />
      </div>
