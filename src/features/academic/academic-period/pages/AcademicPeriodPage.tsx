...
import { AcademicPeriodFormModal } from "../components/form/AcademicPeriodFormModal";
import { AcademicPeriodTable } from "../components/form/AcademicPeriodTable";
import { useAcademicPeriodForm } from "../presentation/hooks/useAcademicPeriodForm";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <AcademicPeriodTable onEdit={openModal} />
      </div>
