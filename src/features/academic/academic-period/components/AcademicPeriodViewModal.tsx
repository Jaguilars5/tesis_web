...
interface AcademicPeriodViewModalState {
  data: AcademicPeriodT | null;
  loading: boolean;
  error: string | null;
}

type AcademicPeriodViewModalAction =
  | { type: "loading" }
  | { type: "success"; data: AcademicPeriodT }
  | { type: "error"; error: string };

const reducer = (
  state: AcademicPeriodViewModalState,
  action: AcademicPeriodViewModalAction,
): AcademicPeriodViewModalState => {
  switch (action.type) {
    case "loading":
...
export const AcademicPeriodViewModal: React.FC<
  AcademicPeriodViewModalProps
> = ({ isOpen, periodId, onClose }) => {
