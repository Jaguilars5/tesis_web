...
import { SubjectAcademicConfigFormModal } from "../components/form/SubjectAcademicConfigFormModal";
import { SubjectAcademicConfigTable } from "../components/form/SubjectAcademicConfigTable";
import { useSubjectAcademicConfigsForm } from "../presentation/hooks/useSubjectAcademicConfigForm";
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Gestiona las horas y orden de materias por grado academico
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <SubjectAcademicConfigTable onEdit={openModal} />
      </div>
