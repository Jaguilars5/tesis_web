...
import type { QualitativeScaleDeleteParamsT } from "../qualitative-scales.types";
import type { QualitativeScaleT } from "../qualitative-scales.types";

interface Props {
  isOpen: boolean;
  entity: QualitativeScaleT | null;
  onClose: () => void;
  onSoftDelete: (
    params: QualitativeScaleDeleteParamsT,
  ) => Promise<SoftDeleteResponseT>;
}

export const QualitativeScaleDeleteModal: React.FC<Props> = ({
  isOpen,
  entity,
  onClose,
  onSoftDelete,
        ...
        <div className="p-5">
          ...
          {phase === "deactivating" && (
            <div className="flex flex-col items-center gap-3 py-6 text-center">
              ...
              <p className="text-sm text-slate-500">Desactivando escala...</p>
            </div>
          )}
            ...
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <div>
                <p className="text-sm font-medium text-slate-900">
                  Escala desactivada exitosamente
                </p>
          ...
          {phase === "error" && (
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <p className="text-sm text-red-600">
                {errorMsg ?? "Error al desactivar la escala"}
              </p>
            </div>
          )}
        </div>
