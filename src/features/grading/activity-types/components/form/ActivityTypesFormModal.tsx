...
import { activityTypeSchema } from "../../presentation/utils/activity-types.validation";

import type { ActivityTypeT } from "../../domain/entities/activity-types.types";
import type { ActivityTypeFormValues } from "../../presentation/hooks/useActivityTypesForm";
...
export const ActivityTypesFormModal = ({
  isOpen,
  onClose,
  isEdit,
  editingActivityType,
  onSubmit,
}: ActivityTypesFormModalProps) => {
  const getInitialValues = (): ActivityTypeFormValues => {
    if (editingActivityType) {
      return {
        ...
        is_active: editingActivityType.is_active,
        order: editingActivityType.order,
      };
    }
    return {
      code: "",
  ...
  useEffect(() => {
    if (isOpen && editingActivityType) {
      formik.setValues(getInitialValues());
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isOpen, editingActivityType]);
