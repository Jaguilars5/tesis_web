...
import type { StudentNoteDeleteParamsT } from "../student-notes.types";
import type { StudentNoteT } from "../student-notes.types";

interface Props {
  isOpen: boolean;
  entity: StudentNoteT | null;
  onClose: () => void;
  onSoftDelete: (
    params: StudentNoteDeleteParamsT,
  ) => Promise<SoftDeleteResponseT>;
}

export const StudentNoteDeleteModal: React.FC<Props> = ({
  isOpen,
  entity,
  onClose,
  onSoftDelete,
        ...
        <div className="p-5">
              ...
              <div className="flex flex-col items-center gap-4 py-2 text-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {entity.evaluative_activity_title}
                  </p>
                </div>
              </div>
              {message && (
          ...
          {phase === "deactivating" && (
            <div className="flex flex-col items-center gap-3 py-6 text-center">
              ...
              <p className="text-sm text-slate-500">Desactivando nota...</p>
            </div>
          )}
          ...
          {phase === "error" && (
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <p className="text-sm text-red-600">
                {errorMsg ?? "Error al desactivar la nota"}
              </p>
            </div>
          )}
        </div>
