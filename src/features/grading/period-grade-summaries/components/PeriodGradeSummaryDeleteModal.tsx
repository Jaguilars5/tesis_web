...
import type { PeriodGradeSummaryDeleteParamsT } from "../period-grade-summaries.types";
import type { PeriodGradeSummaryT } from "../period-grade-summaries.types";

interface Props {
  isOpen: boolean;
  entity: PeriodGradeSummaryT | null;
  onClose: () => void;
  onSoftDelete: (
...
export const PeriodGradeSummaryDeleteModal: React.FC<Props> = ({
  isOpen,
  entity,
  onClose,
  onSoftDelete,
        ...
        <div className="p-5">
          ...
          {(phase === "deactivating") && (
            <div className="flex flex-col items-center gap-3 py-6 text-center">
              ...
              <p className="text-sm text-slate-500">Desactivando resumen...</p>
            </div>
          )}
            ...
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <div>
                <p className="text-sm font-medium text-slate-900">
                  Resumen desactivado exitosamente
                </p>
          ...
          {phase === "error" && (
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <p className="text-sm text-red-600">{errorMsg ?? "Error al desactivar el resumen"}</p>
            </div>
          )}
        </div>
