...
export const EvaluativeActivityDeleteModal: React.FC<
  EvaluativeActivityDeleteModalProps
> = ({ isOpen, evaluativeActivity, onClose, onSoftDelete }) => {
  const {
    phase,
    message,
    affectedRecords,
