...
export const useEvaluativeActivityOptions = () => {
  ...
  return { teacherSubjectSectionOptions: state.teacherSubjectSectionOptions, activityTypeOptions: state.activityTypeOptions, academicPeriodOptions, loading: state.loading };
};
