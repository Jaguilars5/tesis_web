...
import type { RoleDeleteParamsT } from "../roles.types";
...
interface Props {
  ...
  onClose: () => void;
  onSoftDelete: (
    params: RoleDeleteParamsT,
  ) => Promise<SoftDeleteResponseT>;
}

export const RolesDeleteModal: React.FC<Props> = ({
  isOpen,
  entity,
  onClose,
  onSoftDelete,
        ...
        <div className="p-5">
          ...
          {phase === "deactivating" && (
            <div className="flex flex-col items-center gap-3 py-6 text-center">
              ...
              <p className="text-sm text-slate-500">Desactivando rol...</p>
            </div>
          )}
          ...
          {phase === "error" && (
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <p className="text-sm text-red-600">
                {errorMsg ?? "Error al desactivar el rol"}
              </p>
            </div>
          )}
        </div>
