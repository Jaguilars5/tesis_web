export type { PermissionT, PermissionFormValues, PermissionOrderingT, PermissionListParamsT, PermissionCreateDataT, PermissionCreateParamsT, PermissionUpdateDataT, PermissionUpdateParamsT, PermissionGetParamsT, PermissionDeleteParamsT, PermissionServiceT } from "./permission";
...
export type { RoleT, RoleFormValues, RoleOrderingT, RoleListParamsT, RoleCreateDataT, RoleCreateParamsT, RoleUpdateDataT, RoleUpdateParamsT, RoleGetParamsT, RoleDeleteParamsT, RoleServiceT, RolePermissionT, RoleAssignPermissionsDataT } from "./roles";
