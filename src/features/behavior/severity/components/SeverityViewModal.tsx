...
interface SeverityViewModalProps {
  isOpen: boolean;
  severityId: number | null;
  onClose: () => void;
}

export const SeverityViewModal: React.FC<SeverityViewModalProps> = ({
  isOpen,
  severityId,
  onClose,
}) => {
          ...
          {state.data && (
            <div className="space-y-5">
              ...
              <DetailRow
                icon={<FileText className="size-4" />}
                label="Descripción"
                value={state.data.description || "Sin descripción"}
              />
