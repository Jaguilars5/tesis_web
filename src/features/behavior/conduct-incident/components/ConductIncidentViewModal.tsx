    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative flex max-h-[85vh] w-full max-w-lg flex-col animate-slide-up overflow-hidden rounded-xl bg-white shadow-xl">
        <div className="flex shrink-0 items-center justify-between border-b border-slate-200 px-5 py-3">
          <div><h3 className="text-base font-semibold text-slate-900">Incidente de Conducta</h3><p className="text-xs text-slate-500">Detalle del incidente reportado</p></div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-3">
          ...
          {state.data && (<div className="space-y-3">
            <div className="grid grid-cols-2 gap-x-4 gap-y-2">
              ...
              <DetailRow icon={<FileText className="size-3.5" />} label="Tipo" value={state.data.incident_type_name} />
